            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-col md:flex-row items-center gap-10">
                    <div className="md:w-1/2 flex justify-end">
                        <img src={akualmet} alt="Foto Ramadhan Cahaya" loading="lazy" className="w-1/2 h-1/2 rounded-lg object-cover shadow-lg md:mr-28"/>
                    </div>
                    <div className="md:w-1/2 flex justify-normal bg-gradient-to-r from-slate-900 to-blue-950 p-8 text-gray-200 rounded shadow-lg md:mr-20 rounded-lg">
